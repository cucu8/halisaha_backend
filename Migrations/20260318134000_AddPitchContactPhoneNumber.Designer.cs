...
namespace halisaha_backend.Migrations
{
    ...
    [Migration("20260318134000_AddPitchContactPhoneNumber")]
    partial class AddPitchContactPhoneNumber : Migration
    {
            ...
            modelBuilder.Entity("HalisahaBackend.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Admin",
                            PasswordHash = "$2a$11$G6OHi1E7mc8HZINDRoJoqOSmPC/hbdzDZIc5geq4t7A.mkQtYnf8G",
