...
public record PitchResponseDto(int Id, string Name, string Address, string City, string District, string OwnerPhoneNumber, string ContactPhoneNumber, decimal HourlyPrice, List<string> Features, bool IsActive);
...
public record UpdatePitchRequest(string Name, decimal HourlyPrice, bool IsActive);
