...
public record OwnerPitchDto(int Id, string Name, string? City, string? District, string? Address, bool IsActive);
public record PitchResponseDto(int Id, string Name, string Address, string City, string District, string OwnerPhoneNumber, bool IsActive);
...
public record CreatePitchRequest(string Name, int DistrictId, string? Address);
public record UpdatePitchRequest(string Name, bool IsActive);
